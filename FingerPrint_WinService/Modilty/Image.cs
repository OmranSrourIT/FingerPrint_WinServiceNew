...
namespace FingerPrint_WinService.Modilty
{
    ...
    public class Image
    {
            ...
            public Image(string captureDevice = default(string), byte[] dataBytes = default(byte[]), string dataUrl = default(string), FormatEnum? format = default(FormatEnum?), int resolutionDpi = default(int))
            {
